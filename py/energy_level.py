...
#################################### Input #####################################
directory = "/home/likejun/work/hBN/Ti/7x7/nonradiative/relax-gs"
...
(spinu_E, spind_E, vbm, cbm, fermi) = energy_level(list_E_spinu, list_E_spind,
list_occ_spinu, list_occ_spind, lowerlimit=4, upperlimit=6, distance=4)
